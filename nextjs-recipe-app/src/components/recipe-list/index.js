                    ...
                    {recipeList && recipeList.length > 0
                        ? recipeList.map((recipe) => (
                            <Link href={`/recipe-list/${recipe.id}`}>
                                <Card>
                                    <CardContent className="bg-white rounded-md overflow-hidden shadow-md cursor-pointer hover:[1.1]">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="mt-4 flex items-center flex-wrap gap-2">
                                                ...
                                                <div className="ml-auto">
                                                    <p className="tex-lg text-gray-600 font-bold">{recipe.cuisine}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </CardContent>
